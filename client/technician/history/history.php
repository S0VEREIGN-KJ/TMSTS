...
$sql = "SELECT * FROM ticket WHERE assigned_name = ? AND status IN ('Repaired', 'Closed') ORDER BY datetime_req DESC";
...
if ($result->num_rows === 0) {
    echo "<p>No tickets found for the specified criteria.</p>";
} else {
  ...
  $.ajax({
      ...
      success: function(data) {
          ...
          imageElement.src = 'data:image/jpeg;base64,' + imageBase64;
             // Call the feedback overlay function with ticket number and assigned name
    openFeedbackOverlay(ticketDetails.ticket_number, ticketDetails.assigned_name);
