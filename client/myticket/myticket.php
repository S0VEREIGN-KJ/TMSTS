...
// SQL query to retrieve the user's my tickets
$sql = "SELECT * FROM ticket WHERE id_number = ? AND status IN ('In Progress', 'Pending', 'Scheduled') ORDER BY datetime_req DESC";
...
<div class="overlay_form_group">
          ...
          <div class="overlay_form_group">
              ...
              <input type="text" id="category" name="category"   readonly > <!-- unit -->
          </div>
