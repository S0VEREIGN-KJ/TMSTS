...
<input type="text" name="ticket_number" placeholder="Search by Ticket Number"
value="<?php echo isset($_GET['ticket_number']) ? htmlspecialchars($_GET['ticket_number']) : ''; ?>">
...
<div class="overlay-content">
  <div class="overlay_container">
    ...
    <form id="printForm" action="generate_condemn.php" method="POST" target="_blank">
...
<div class="overlay_form_group">
    <label for="unit_description" style="text-decoration: underline; color:green; font-weight:bold;">Device Description:</label>
    <input type="text" id="unit_description" name="unit_description" placeholder="Put device description...." value="" required> <!-- unit description -->
</div>

<div class="overlay_form_group">
    <label for="requested_by" style="text-decoration: underline; color:green; font-weight:bold;" >Requested by</label>
    <input type="text" id="requested_by" name="requested_by" placeholder="Requested by...." value="" required> <!-- requester name -->
</div>

<div class="overlay_form_group">
    <label for="condition_status" style="text-decoration: underline; color:green; font-weight:bold;" >Condition/Status:</label>
    <input type="text" id="condition_status" name="condition_status" placeholder="Device status...." value="" required> <!-- condition/status -->
</div>

<div class="overlay_form_group">
    <label for="reason_condemnation" style="text-decoration: underline; color:green; font-weight:bold;" >Reason of Condemnation:</label>
    <input type="text" id="reason_condemnation" name="reason_condemnation" placeholder="Reason of condemn...." value="" required> <!-- reason for condemnation -->
</div>

<div class="overlay_form_group">
    <label for="comment_text" style="text-decoration: underline; color:green; font-weight:bold;" >Comment:</label>
    <input type="text" id="comment_text" name="comment_text" placeholder="Put comment...." value="" required> <!-- comment -->
</div>
    ...
    <div class="overlay_form_group">
      ...
      <button type="submit" onclick="createCondemn()" style="background-color: #008CBA; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;">
    Print Condemnation
  </button>
...
<script>
function createCondemn() {
  document.getElementById("form_date_today").value = document.getElementById("date_today").value;
  document.getElementById("form_serial_number").value = document.getElementById("serial_number").value;
  document.getElementById("form_unit").value = document.getElementById("unit").value;
  document.getElementById("form_category").value = document.getElementById("category").value;
  document.getElementById("form_office").value = document.getElementById("office").value;
  document.getElementById("form_ticket_count").value = document.getElementById("ticket_count").value;
  document.getElementById("form_unit_description").value = document.getElementById("unit_description").value;
  document.getElementById("form_requested_by").value = document.getElementById("requested_by").value;
  document.getElementById("form_condition_status").value = document.getElementById("condition_status").value;
  document.getElementById("form_reason_condemnation").value = document.getElementById("reason_condemnation").value;
  document.getElementById("form_comment_text").value = document.getElementById("comment_text").value;
}
...
function openNav(ticketNumber) {
    // Set today's date when overlay is opened
    var today = new Date();
    var monthNames = [
